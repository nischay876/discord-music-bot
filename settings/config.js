...
module.exports = {
    ...
    LIMIT_TRACK: parseInt(process.env.LIMIT_TRACK || "50000"),  //<= dafault is "100" // limit track in playlist
    LIMIT_PLAYLIST: parseInt(process.env.LIMIT_PLAYLIST || "5000"), //<= default is "10" // limit can create playlist
