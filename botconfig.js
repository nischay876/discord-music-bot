module.exports = {
  ...
  Scopes: ["identify"],//Discord OAuth2 Scopes
  ServerDeafen : true,//If you want bot to stay deafened
  DefaultVolume: 90, //Sets the default volume of the bot, You can change this number anywhere from 1 to 100
  CallbackURL: "/api/callback", //Discord OAuth2 Callback URL
  "24/7": false, //If you want the bot to be stay in the vc 24/7
  CookieSecret: "oggyiscute", //A Secret like a password
  StatusPage: "https://mecute.instatus.com/",
  IconURL: "https://i.imgur.com/CW6sCf8.gif", //URL of all embed author icons | Dont edit unless you dont need that Music CD Spining
