...
module.exports = { 
    ...
    config: {
        name: "givepremium",
        aliases: [],
        usage: "givepremium <plan> <user id>",
    ...
    .setColor('#303236')
    .setThumbnail('https://cdn.discordapp.com/attachments/890262013484363806/975212551837216788/unknown.png?size=4096')
    .setTitle(`Thank You For Buying ${plan} Premium`)
